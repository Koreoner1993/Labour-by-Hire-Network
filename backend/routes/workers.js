  ...
  try {
    ...
    res.json({
      worker: {
        ...
        hedera_token_id: worker.hedera_token_id || null,
        hedera_serial: worker.hedera_serial || null,
        badge_svg_uri: worker.badge_svg_uri || null,
        badge_metadata_uri: worker.badge_metadata_uri || null,
